    ...
    public ResponseEntity<?> getStats() {
        try {
            ...
            try {
                ...
                for (Object[] r : hourly) {
                    hourMap.put(Integer.parseInt(String.valueOf(r[0])), Long.parseLong(String.valueOf(r[1])));
                }
